...
This update builds on top of Matt Shepherd's Quadify front end for Volumio. 
...
IMPORTANT: I suggest you use a second SD card for this installation, and keep your stable Volumio/Quadify install safe.
...
To use this fork, install Volumio according to the Main Quadify Repository below. Then, when you get to the step to install Quadify:
